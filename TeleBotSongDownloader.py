...
from telegram.ext.dispatcher import JJJ0U                                           # python-telegram-bot library
...
updater = Updater(token["Telegram"], workers=200)             # Starts 200 threads for "updater" (declared with '@JJJ0U' decorator)
